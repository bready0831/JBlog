    ...
    <>
      ...
      >
        <div className="flex-1 min-w-0">
          ...
          {post.description && (
            <p className="text-base text-muted-foreground leading-relaxed mb-4 line-clamp-1">
              {post.description}
            </p>
          )}
        ...
        {post.thumbnail_url && (
          <div className="relative w-32 h-24 shrink-0 overflow-hidden rounded-sm bg-muted">
            <Image
